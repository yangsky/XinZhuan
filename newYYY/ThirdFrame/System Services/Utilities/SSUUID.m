...
//    NSLog(@"------ScreenHeight-----%@",ScreenHeight);
...
//    NSLog(@"------WiFiMACAddress2-----%@",WiFiMACAddress2);
...
//    NSLog(@"------WiFiMACAddress3-----%@",WiFiMACAddress3);
